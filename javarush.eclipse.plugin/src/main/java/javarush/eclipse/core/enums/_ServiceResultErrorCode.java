...
public enum _ServiceResultErrorCode {
    SUCCESS(ServiceResultErrorCode_Success), AUTHORIZATION_ERROR(
            ServiceResultErrorCode_AuthorizationError), REQUEST_TIMEOUT(
            ServiceResultErrorCode_RequestTimeout), SERVER_UNAVAILABLE(
            ServiceResultErrorCode_ServerUnavailable), API_VERSION_MISMATCH(
            ServiceResultErrorCode_ApiVersionMismatch), UNKNOWN_USER(
            ServiceResultErrorCode_UnknownUser), UNKNOWN_TASK(
            ServiceResultErrorCode_UnknownTask), TASK_SOLVED(
            ServiceResultErrorCode_TaskSolved), TASK_UNAVAILABLE(
            ServiceResultErrorCode_TaskUnavailable), ACCESS_DENIED(
            ServiceResultErrorCode_AccessDenied), UNKNOWN_ERROR(
            ServiceResultErrorCode_UnknownError);
